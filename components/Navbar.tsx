      ...
      <nav className="mx-auto max-w-7xl px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            />
            <span
              className={`${silkscreen.className} hidden text-xl font-bold sm:inline ${
                resolvedTheme === 'dark' 
                  ? 'text-white bg-gradient-to-r from-primary-dark to-secondary-dark bg-clip-text text-transparent' 
                  : 'text-black'
              }`}
            >
              GameVault
