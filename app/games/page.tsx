    ...
    const fetchGames = async () => {
      try {
        ...
        const popular = await getPopularGames().catch(error => {
          ...
          setError(new Error('Failed to load popular games. Please try again later.'));
          return [];
        });
        
        const trending = await getTrendingGames().catch(error => {
          console.error('Error fetching trending games:', error);
          setError(new Error('Failed to load trending games. Please try again later.'));
          return [];
        });
        ...
        setError(new Error('Failed to load games. Please check your internet connection and try again.'));
      } finally {
        setIsLoading(false);
      }
    };
