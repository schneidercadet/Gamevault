            ...
            <div className="flex items-start space-x-6">
              ...
              <div className="flex-1">
                    ...
                    <div className="flex space-x-2">
                      {isFriend ? (
                        <Button
                          ...
                          onClick={() => window.location.href = `/messages/${profile.username}`}
                        >
                          Message
                        </Button>
                      ) : (
                ...
                {profile.socialLinks && Object.keys(profile.socialLinks).length > 0 && (
                  <div className="mt-6">
                    <h2 className="mb-2 text-lg font-semibold text-foreground">Social Links</h2>
                ...
                {profile.favoriteGames && profile.favoriteGames.length > 0 && (
                  <div className="mt-6">
                    <h2 className="mb-2 text-lg font-semibold text-foreground">Favorite Games</h2>
